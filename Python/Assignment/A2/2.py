...
def process_student_grades(students):
    ...
    return overall_average_grade, highest_grade, lowest_grade, top_performers, grade_distribution
...
def main():
    overall_average, highest_grade, lowest_grade, top_performers, grade_distribution = process_student_grades(students_data)
    
    # Display the calculated results
    display_results(overall_average, highest_grade, lowest_grade, top_performers, grade_distribution)
